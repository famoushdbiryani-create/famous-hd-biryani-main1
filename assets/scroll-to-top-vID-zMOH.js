      ...
      <div class="premium-header-shell">
        ...
        <div class="premium-header-right">
          <div class="pp-right-nav">
            <a href="/#contact-location" class="nav-link pp-nav-text" data-nav-key="contact">CONTACT</a>
            <a href="/#contact-location" class="nav-link pp-nav-text" data-nav-key="location">LOCATION</a>
          </div>
    ...
    <div id="premium-menu-content" role="dialog" aria-modal="true" aria-labelledby="mobile-navigation-title">
      ...
      <div class="mobile-menu-body">
        <nav class="premium-mobile-nav">
          ...
          <a href="/#contact-location" class="premium-nav-link" data-nav-key="contact">CONTACT</a>
          <a href="/#contact-location" class="premium-nav-link" data-nav-key="location">LOCATION</a>
        </nav>
