...
html_template = """
    <!-- Hero Section -->
    <section class="relative w-full bg-black flex items-center justify-center overflow-hidden">
        <img alt="FIFA World Cup Special Menu Poster" class="w-full h-auto object-contain max-h-[80vh]"
            src="./assets/fifa-worldcup-poster.jpg"
             decoding="async" loading="eager" fetchpriority="high" />
        
        <div class="menu-halal-stamp-container absolute top-4 right-4 md:top-8 md:right-8 z-10">
            <img alt="100% Halal Certified Indian Food McKinney" class="menu-halal-stamp w-16 md:w-24" src="./assets/halal-CcoUxlhx.webp" width="600" height="600" decoding="async" loading="eager" />
        </div>
    </section>
